...
import com.abao.rcode.camera.CameraManager;
import com.abao.rcode.camera.PreviewFrameShotListener;
import com.abao.rcode.camera.Size;
import com.abao.rcode.decode.DecodeListener;
import com.abao.rcode.decode.DecodeThread;
import com.abao.rcode.decode.LuminanceSource;
import com.abao.rcode.decode.PlanarYUVLuminanceSource;
import com.abao.rcode.decode.RGBLuminanceSource;
import com.abao.rcode.util.DocumentUtil;
import com.abao.rcode.view.CaptureView;
...
public class CaptureActivity extends Activity implements SurfaceHolder.Callback, PreviewFrameShotListener, DecodeListener,
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        if (!mCameraManager.isCameraAvailable()) {
            Toast.makeText(CaptureActivity.this, "camerfail", Toast.LENGTH_SHORT).show();
            finish();
            return;
        }
